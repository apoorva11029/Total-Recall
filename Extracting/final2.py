...
from apoo_config import CONSUMER_KEY,CONSUMER_SECRET,ACCESS_TOKEN,ACCESS_TOKEN_SECRET
...
# ENGLISH QUERIE
#querys = ['pray4paris','Paris attacks','Eagles of Death Metal','pray4peace','Bataclan','Bataclan theatre','Le Carillon','ISIL Paris','pray4syria','Syria attacks','syria conflict','syria refugees','#parisattacks']
#querys=['pray4syria','Syria attacks','syria conflict','syria refugees','syria air strikes','#notinmyname','bashar al-assad','syrian civil war','civil war of syria','civil war in syria','syrian army','Shia Islamist Hezbollah ','hezbollah','assad','daesh','flight 9268']
#querys = '"syrian refugees" since:2015-11-15 until:2015-11-28'
#querys=['syria air strikes','#notinmyname','bashar al-assad','syrian civil war','civil war of syria','civil war in syria','syrian army','Shia Islamist Hezbollah ','hezbollah','assad','daesh','flight 9268']
...
for lang in langs:
    for query in querys:
        ...
        for tweets in tweepy.Cursor(api.search, q=query.encode('utf-8'), since="2015-11-15",until="2015-12-02",lang=lang, count=40).pages(1):
            #print tweets
            #print len(tweets)
            #raw_input()
            for tweet in tweets:
